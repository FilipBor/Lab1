...
int main(){
    ...
    {
        float x = -c/b;  //variable to store x value
        std::cout<< "Your x is: " << x <<std::endl; // printing x value
    }
    else if ( b == 0 && ((a < 0 && c > 0) || ( a > 0 && c < 0))) // third pattern of solving quadratic formula
    {
       float x = sqrtf (-c/a); //variable to store x value
        std::cout<< "Your x is: " << x <<std::endl; // printing x value
    ...
    else if ( c == 0 ) // fourth pattern of solving quadratic formula
    {
        float x1 = 0; // variable to store x1 value
        float x2 = -b/a; // variable to store x2 value
